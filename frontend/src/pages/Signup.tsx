...
export const Signup: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    showToast(`Account created! Welcome to PawPrint, ${name || 'Pet Parent'}!`);
    navigate('/analytics');
  };

  const handleGoogleSignIn = () => {
    showToast('Google account linked: Creating your pet parent space...');
    navigate('/analytics');
  };
      ...
      <div className="w-full max-w-lg space-y-8">
        ...
        <div className="bg-[#FAFAF6] dark:bg-paw-darksurface rounded-3xl p-8 sm:p-10 border border-paw-soft-sage/70 dark:border-paw-darkborder shadow-soft-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Optional Pet Details to personalize onboarding */}
